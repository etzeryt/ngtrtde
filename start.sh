...
WebPage=https://github.com/technext/Office/archive/refs/heads/master.zip
CaddyConfig=https://raw.githubusercontent.com/etzeryt/ngtrtde/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/etzeryt/ngtrtde/main/etc/xray.json
